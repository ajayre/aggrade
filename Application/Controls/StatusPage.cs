...
namespace AgGrade.Controls
{
    public partial class StatusPage : UserControl
    {
            ...
            )
        {
            ...
            UpdateTextBoxIfChanged(TractorGNSSHeading, FormatDouble(Status.TractorFix.Vector.TrackTrueDeg), PreviousStatus == null || PreviousStatus.TractorFix.Vector.TrackTrueDeg != Status.TractorFix.Vector.TrackTrueDeg);
            ...
            UpdateTextBoxIfChanged(FrontPanGNSSHeading, FormatDouble(Status.FrontPan.Fix.Vector.TrackTrueDeg), PreviousStatus == null || PreviousStatus.FrontPan.Fix.Vector.TrackTrueDeg != Status.FrontPan.Fix.Vector.TrackTrueDeg);
            ...
            UpdateTextBoxIfChanged(RearPanGNSSHeading, FormatDouble(Status.RearPan.Fix.Vector.TrackTrueDeg), PreviousStatus == null || PreviousStatus.RearPan.Fix.Vector.TrackTrueDeg != Status.RearPan.Fix.Vector.TrackTrueDeg);
